...
List<RestuarantModel> restuarantModelFromJson(String str) =>
    List<RestuarantModel>.from(
        json.decode(str).map((x) => RestuarantModel.fromJson(x)));

String restuarantModelToJson(List<RestuarantModel> data) =>
